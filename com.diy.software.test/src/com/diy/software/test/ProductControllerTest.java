...
public class ProductControllerTest {
	...
	public void testDisable() {
		stationLogic.station.turnOn();
		stationLogic.station.scanner.disable();
		assertTrue(stationLogic.station.scanner.isDisabled());
	}
	
	@Test
	public void testEnable() {
		stationLogic.station.turnOn();
		stationLogic.station.scanner.enable();
		assertFalse(stationLogic.station.scanner.isDisabled());
	}
